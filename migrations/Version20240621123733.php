 ...
 */
final class Version20240621123733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD CONSTRAINT FK_DA88B137727ACA70 FOREIGN KEY (parent_id) REFERENCES recipe (id)');
